          ...
          User.create({ username: 'foo' }).success(function(user) {
            Task.create({ title: 'task' }).success(function(task) {
              task.setUser(user).success(function() {
                ...
                // We will now update the id of the user.
                // This will cascade the update to the task as well.
                // The UserId of the task should equal the new id of the user.
                ...
                user
                  .QueryInterface
                  .update(user, tableName, {id: 999}, user.id)
                  .success(function() {
                    Task.findAll().success(function(tasks) {
                      expect(tasks).to.have.length(1)
