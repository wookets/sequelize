  ...
  var QueryGenerator = {
    ...
    */
    ...
    startTransactionQuery: function(options) {
      return "-- Transaction is started via the connector library."
    },

    setIsolationLevelQuery: function(value) {
      return "-- Isolation level is set via the connector library."
    },
    ...
    commitTransactionQuery: function() {
      return "-- Transaction is commited via the connector library."
    },

    rollbackTransactionQuery: function(options) {
      return "-- Transaction is rollbacked via the connector library."
    },
