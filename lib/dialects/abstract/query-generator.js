  ...
  var QueryGenerator = {
    ...
    */
    insertQuery: function(table, valueHash, modelAttributes) {
      ...
      if (this._dialect.supports['OUTPUT INSERTED']) {
        var value = " OUTPUT INSERTED.*, IDENT_CURRENT(" + this.addQuotes(table, "'") + ") AS insertId"

        valueQuery = valueQuery.replace(") VALUES", ") " + value + " VALUES")
        emptyQuery += value
      }
