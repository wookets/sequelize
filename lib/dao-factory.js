...
module.exports = (function() {
  ...
  */
  ...
  DAOFactory.prototype.bulkCreate = function(records, fieldsOrOptions, options) {
    ...
    if (options.ignoreDuplicates && !this.sequelize.dialect.supports.ignoreDuplicates) {
      return new Utils.CustomEventEmitter(function(emitter) {
        var dialect = self.sequelize.options.dialect
          , err     = new Error(Utils._.camelize(dialect) + " does not support the 'ignoreDuplicates' option.")
      ...
      var runQuery = function() {
        ...
        daos.forEach(function(dao) {
          ...
          Object.keys(values).forEach(function(key) {
            if ((self.rawAttributes[key].allowNull === false) && (values[key] === null)) {
              delete values[key]
            }
          })
